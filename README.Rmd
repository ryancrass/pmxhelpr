...
Plot aesthetics are controlled through theme factories and element constructors. Each plot function has a corresponding `*_theme()` factory:
  ...
  + `plot_dvtime_theme()`, `plot_dvconc_theme()`, `plot_doseprop_theme()`, `plot_gof_theme()`, `plot_vpc_theme()` — return named lists of default element objects for the `theme` argument of their corresponding plot function
