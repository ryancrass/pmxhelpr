...
* Helper functions: <return object>_<purpose>
  + `df_nobsbin` returns a summary `data.frame` with counts of the number of missing and non-missing observations per bin returning a `data.frame`
  + `df_predcorr` returns a `data.frame` containing a new variable of prediction-corrected values of the dependent variable
