...
Say we want to update the errorbar cap width to be more visible in our prior geometric mean +/- geometric SD plot with the interaction of dose and food passed to the color aesthetic. Error bar cap width is the `errorbar_width` style field (in x-axis units); when unset it defaults to 2.5% of the maximum nominal time.
