...
The default aesthetics for Response-Time plots are controlled via `style_dvtime()`. See the [Plot Themes and Aesthetics](plot-themes.html) vignette for details on the styling system, the `style_spec()` fields, and examples of customizing Response-Time aesthetics.
...
The default aesthetics for Response-Concentration plots are controlled via `style_dvconc()`. See the [Plot Themes and Aesthetics](plot-themes.html) vignette for details on the styling system, the `style_spec()` fields, and examples of customizing Response-Concentration aesthetics.
