...
`plot_gof()` aesthetic control arguments are not reviewed in detail in this vignette. See the [Plot Styling and Aesthetics](plot-themes.html) vignette for details on customizing plot appearance.
