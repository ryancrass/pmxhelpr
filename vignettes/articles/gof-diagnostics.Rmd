...
Say we want add points at the binned values for the central tendency lines. The points are suppressed by default `alpha=0`. We can accomplish thia theme changes by defining a new theme and passing that to the `theme` argument of `plot_dvconc()`.
