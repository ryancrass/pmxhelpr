...
Additional arguments can be passed to `mrgsim_df()` via the ellipses `...`. One argument that may sometimes be useful is `obsonly = TRUE`. This argument removes dose records from the simulation output and reduce file size.
