...
The default aesthetics for VPC plots are controlled via `style_vpc()`. See the [Plot Themes and Aesthetics](plot-themes.html) vignette for details on the styling system, the `style_spec()` fields, and examples of customizing VPC aesthetics.
