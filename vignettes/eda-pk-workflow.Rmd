...
Data points may be connected longitudinally within an individual by specifying `id_line = TRUE`. The grouping variable defaults to `ID` and can be changed with `id_var`. The grouping variable inherits the variable mapped to the color aesthetic with `col_var`. The central tendency may be removed by specifying `cent ="none"` or the median may be plotted by specifying `cent="median"`.
...
plot_dvtime(plot_data_pk, dv_var = ODV, col_var = `Dose and Food`, 
            cent = "none",log_y = TRUE, id_line = TRUE,
            loq_method = 2, loq = 1) +
