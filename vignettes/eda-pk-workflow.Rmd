...
The default attributes of data points and lines are controlled by the `theme` argument via `plot_dvtime_theme()`. See the [Plot Themes and Aesthetics](plot-aesthetics.html) vignette for details on the theme system, element constructors, and examples.
