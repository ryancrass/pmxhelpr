...
Let's visualize the data. First, we will filter to response observation records only (CMT=3) and derive some factor variables, which can be passed to the color aesthetic in our plots. Let's first visualize these data versus time using `plot_dvtime`.
