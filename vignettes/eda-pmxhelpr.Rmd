...
The default error bar width is 2.5% of the maximum nominal time in the dataset. This can be overwritten to a user-specified value using the `theme` argument by specifying the `width_errorbar` value as demonstrated in the code below. These value is passed to the `width` argument of `geom_errorbar`. 
