...
Data points within an individual will be connected by a narrow line when `ind_dv = TRUE` 
...
plot_dvtime(plot_data, dv_var = c(DV = "ODV"), col_var = "Dose (mg)",  
            ylab = "Concentration (ng/mL)", xlab = "Time (hours", loq_method = 2) +
  scale_x_continuous(breaks = seq(0,168,24))+
  scale_y_log10()+
  facet_wrap(~PART)+
  theme_bw()
...
plot_dvtime(plot_data, dv_var = c(DV = "ODV"), col_var = "Dose (mg)",  
            ylab = "Concentration (ng/mL)", xlab = "Time (hours", loq_method = 2, loq = 1) +
  scale_x_continuous(breaks = seq(0,168,24))+
  scale_y_log10()+
  facet_wrap(~PART)+
  theme_bw()
