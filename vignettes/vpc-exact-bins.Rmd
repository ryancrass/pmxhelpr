...
Luckily for us, someone has already fit a PK model to these data! Let's load the mrgsolve model file internal to the pmxhelpr package by calling `model_load()` and take a look at it with `mrgsolve::see()`.
