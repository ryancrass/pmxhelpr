...
Next let's explore our input dataset `data_sad`. This dataset was generated via simulation from the mrgsolve `pkmodel` internal to the pmxhelpr package. We can take a quick look at the dataset using `glimpse()` from the `dplyr`.
