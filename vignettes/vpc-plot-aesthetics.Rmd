...
This vignette will review the functionality for updating aesthetic elements of VPC plots generated using `plot_vpc_cont()` with the `plot_vpc_theme()` function.
