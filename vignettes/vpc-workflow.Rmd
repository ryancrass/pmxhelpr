...
vpc_blq_obs_cens <- plot_vpc_cont(
  sim = sim100,
  strat_var = PART,
  loq = 1
) +
...
vpc_blq_obs_cens2 <- plot_vpc_cont(
  sim = sim100,
  strat_var = PART,
  loq = 1,
...
vpc_blq_obs_cens_wleg <- vpc_blq_obs_cens + vpc_legend + plot_layout(heights = c(2.5,1))
vpc_blq_obs_cens_wleg
```
...
vpc_legend_medonly1 <- plot_vpc_legend(shown = c(obs_ci = FALSE, pi_ci = FALSE))
vpc_legend_medonly1
```

```{r vpc-legend-shown-medonly}
shown_elements <- plot_vpc_shown(obs_ci = FALSE, pi_ci = FALSE)
vpc_legend_medonly2 <- plot_vpc_legend(shown = shown_elements)
vpc_legend_medonly2
```
...
vpc_blq_obs_cens_wleg2 <- vpc_blq_obs_cens2 + vpc_new_legend + plot_layout(heights = c(2.5,1))
vpc_blq_obs_cens_wleg2
```
